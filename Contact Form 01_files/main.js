function calc(){
    ...
    document.getElementById("takeProfit").innerText = document.getElementById("entryPrice").value * (1+document.getElementById("takeProfitP").value / 100)
    document.getElementById("stopLoss").innerText = document.getElementById("entryPrice").value * (1-document.getElementById("stopLossP").value / 100)
